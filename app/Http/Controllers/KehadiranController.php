...
class KehadiranController extends Controller
{
    ...
    {
        $data['kehadiran'] = \App\Kehadiran::findOrFail($id);
        $data['user'] = \App\User::all();
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($kehadiran->save()) {
            ...
            return redirect('kehadiran/edit')->with('error', 'Data kehadiran gagal diperbaharui!');
        }
    }
    ...
    public function destroy($id)
    {
        ...
        if ($kehadiran->delete()) {
            ...
            return redirect('kehadiran')->with('error', 'Data kehadiran gagal dihapus!');
        }
    }
}
